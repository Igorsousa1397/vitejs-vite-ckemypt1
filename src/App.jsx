          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <div style={{ background: G.card, border: `1px solid ${G.cb}`, borderRadius: 16, padding: 16 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                ...
                <div style={{ color: G.tm, fontSize: 10, marginTop: 2 }}>* R$ {VALOR_ENC} padrão / R$ {VALOR_ENC_ITAJAI} Fonte Itajaí — soma dos {todosEnc.length} cadastrados</div>
              </div>
            </div>
...
function CozinhaV({ edit, t, users }) {
  ...
  function BackV({ users, setUsers, fns, setFns, t, expandidos, setExpandidos, permissoes, tab, setTab, gruposAbertos, setGruposAbertos }) {
    ...
    return (
      <div>
        <Seg opts={[["grupos", "Grupos"], ["usuarios", "Atribuições"], ["geral", "Funções"]]} val={tab} set={setTab} />
